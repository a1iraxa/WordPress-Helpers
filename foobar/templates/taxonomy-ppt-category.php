        ...
        <div class="row">
            ...
            <?php 
                ...
                if ($tutorials_parent_term->parent != 0) {
                    ...
                    $child_terms = get_terms('ppt-category', array('parent' => $tutorials_parent_term->term_id, 'orderby' => 'id', 'hide_empty' => false));
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 category-block">
                                    ...
                                    <div class="panel-group accordion" id="accordion">
                                        ...
                                        <?php 
                                            ...
                                            $terms = get_terms('ppt-category', array('parent' => $tutorials_parent_term->term_id, 'hide_empty' => false));
                                            // echo "<pre>";
                                            ...
                                            foreach ($terms as $term) { 
                                                ...
                                                $child_terms = get_terms('ppt-category', array('parent' => $term->term_id, 'hide_empty' => false, 'orderby' => 'id'));
                                ...
                                <aside class="col-sm-4">
                                    ...
                                    <div class="widget " id="library">
                                        ...
                                        <div class="course">
                                            <?php $terms = get_terms('ppt-category', array('parent' => $tutorials_parent_term->term_id, 'hide_empty' => false, 'number' => 6)); ?>
                                            <?php foreach ($terms as $sidebar_parent_term) { ?>

                                                <?php 

                                                    $sidebar_child_terms = get_terms('ppt-category', array('parent' => $sidebar_parent_term->term_id, 'hide_empty' => false, 'number' => 2));
