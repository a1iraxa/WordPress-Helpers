...
/**
 * Class Tutorial_Template_Loader
 *
 * @class Tutorial_Template_Loader
...
class Tutorial_Template_Loader {
	...
	public static function templates( $template ) {
		...
		$custom_post_types = array( 'tutorials', 'news', 'speckers');

		if ( in_array( $post_type, $custom_post_types ) ) {

			if ( is_archive() ) {
				if ( is_tax('pdf-category') ) {
					return self::locate( 'taxonomy-' . get_query_var( 'taxonomy' ) );	
				}
				if ( is_tax('ppt-category') ) {
					return self::locate( 'taxonomy-' . get_query_var( 'taxonomy' ) );	
				}
	 ...
	 * @throws Exception
	 */
	public static function locate( $name, $plugin_dir = TUTORIAL_DIR ) {
		$template = '';
	 ...
	 * @throws Exception
	 */
	public static function load( $name, $args = array(), $plugin_dir = TUTORIAL_DIR ) {
